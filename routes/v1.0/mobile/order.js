 ...
 * @LastEditTime: 2022-01-13 08:49:00
...
router.get('/query', function (req, res, next) {
  ...
  let sqlStr =
    type == '1'
      ? ' and order_status >=3 and order_status < 6' // 进行中
      : type == '2'
      ? ' and order_status = 6 and order_type != 11' // 已完成
      : ' and order_type != 11 and order_created_time between date_sub(now(), interval 6 month ) and now()' // 全部
  DB.queryDB(
